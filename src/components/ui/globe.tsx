...
const GLOBE_CONFIG_DARK: COBEOptions = {
  ...
  markerColor: [96 / 255, 165 / 255, 250 / 255], // Blue-400
...
export function Globe({
  ...
  // Use theme-appropriate config
  const themeConfig = config || (isDark ? GLOBE_CONFIG_DARK : GLOBE_CONFIG_LIGHT)
